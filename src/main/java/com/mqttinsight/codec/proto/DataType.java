...
public interface DataType {
    ...
    enum ScalarType implements DataType {
        ANY, BOOL, BYTES, DOUBLE, FLOAT, FIXED32, FIXED64, INT32, INT64, SFIXED32, SFIXED64, SINT32, SINT64, STRING, UINT32, UINT64;
    ...
    final class MapType implements DataType {
        public static MapType create(DataType keyType, DataType valueType) {
            return new MapType(Element.checkNotNull(keyType, "keyType"), Element.checkNotNull(valueType, "valueType"));
        }
    ...
    final class NamedType implements DataType {
        public static NamedType create(String name) {
            return new NamedType(Element.checkNotNull(name, "name"));
        }
