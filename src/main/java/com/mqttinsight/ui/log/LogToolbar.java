...
public class LogToolbar extends JPanel {
    ...
    public LogToolbar(final LogTab parent, final JTextArea textArea) {
        super();
        this.parent = parent;
    ...
    private void initComponents() {
        ...
        JToggleButton autoScrollButton = new JToggleButton(Icons.SCROLL_DOWN);
        autoScrollButton.setSelected(parent.isScrollToEnd());
        autoScrollButton.setToolTipText(LangUtil.getString("ScrollToEnd"));
        autoScrollButton.putClientProperty(FlatClientProperties.BUTTON_TYPE, FlatClientProperties.BUTTON_TYPE_TOOLBAR_BUTTON);
        autoScrollButton.addActionListener(e -> {
            parent.toggleScrollToEnd(autoScrollButton.isSelected());
        });
        this.add(autoScrollButton, "");

        JButton clearButton = new JButton(Icons.REMOVE);
        clearButton.setToolTipText(LangUtil.getString("ClearAll"));
        clearButton.putClientProperty(FlatClientProperties.BUTTON_TYPE, FlatClientProperties.BUTTON_TYPE_TOOLBAR_BUTTON);
