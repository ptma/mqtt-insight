...
public class MatchExpression {
    ...
    public String toString() {
        return String.format("%s %s %s", expression, comparator != null ? comparator : "", value != null ? value : "");
    }
    ...
    public static MatchExpression jsonPath(String expression, String comparator, String value) {
        MatchExpression matchExpression = new MatchExpression();
        matchExpression.setExpression(expression);
